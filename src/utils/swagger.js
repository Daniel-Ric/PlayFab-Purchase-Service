...
const options = {
    definition: {
        ...
        tags: [
            ...
            {
                name: "Marketplace",
                description: "Creator and offer metadata from the Minecraft Marketplace."
            },
            {
                name: "Inventory",
                description: "Virtual currency balances and owned entitlements."
            },
            {
                name: "Purchase",
                description: "Quoting and executing Minecraft Marketplace purchases."
            },
            {
                name: "Debug",
                description: "Developer utilities useful during integration and testing."
            }
        ],
        components: {
            securitySchemes: {
                            ...
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        offerId: {
                                            type: "string",
                                            description: "Identifier of the offer to quote."
                                        },
                                        price: {
                                            type: "integer",
                                            description: "Price in Minecoins to use for the quote."
                                        },
                                        details: {
                                            type: "object",
                            ...
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        ...
                                        price: {
                                            type: "integer",
                                            description: "Price in Minecoins that will be debited."
                                        },
                                        xuid: {
                                            type: "string",
